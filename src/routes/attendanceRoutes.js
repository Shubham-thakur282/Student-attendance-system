...
router.get("/show-attendance-student/:enrollNo", auth, getAttendanceByStudent); //this and next function are same just the role is changed in case if parent or student
